...
import firzap.restful.model.WebResponse;
...
class AddressControllerTest {
    ...
    void setUp() {
        ...
        contact.setFirstName("Yadi");


        contact.setLastName("Mulyadi");
        contact.setEmail("yadmul@example.com");
        contact.setPhone("08126262626");
